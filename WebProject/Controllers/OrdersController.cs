...
namespace WebProject.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RestaurantId,IsDineIn,CreatedAt")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RestaurantId,IsDineIn,CreatedAt")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
